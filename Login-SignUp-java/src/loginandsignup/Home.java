...
public class Home extends javax.swing.JFrame {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        // add  table row in product
        DefaultTableModel model = (DefaultTableModel) jTable5.getModel();
        model.addRow(new Object[]{PC.getText(),PN.getText(),PQ.getText(),CP.getText(),SP.getText(),PB.getText()});
    ...
    private void AddBtnCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnCActionPerformed
        // add  table row in Customers
        DefaultTableModel model = (DefaultTableModel) jTable3.getModel();
        model.addRow(new Object[]{CI.getText(),FN.getText(),L.getText(),C.getText(),DA.getText(),CA.getText()});
    ...
    private void SaddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaddBtnActionPerformed
        // add  table row in Sales
        DefaultTableModel model = (DefaultTableModel) jTable4.getModel();
        model.addRow(new Object[]{SPC.getText(),SPN.getText(),SQ.getText(),SCP.getText(),SSP.getText()});
